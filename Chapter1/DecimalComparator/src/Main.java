...
//
//        * areEqualByThreeDecimalPlaces(-3.1756, -3.175); → should return true since numbers are equal up to 3 decimal
//        places.
//
...
public class Main {
    ...
    public static boolean areEqualByThreeDecimalPlaces( double numberOne, double numberTwo ) {
        ...
        if ( (int)( numberOne * 1000 ) == (int)( numberTwo * 1000 ) )   return true;
        else                                                            return false;
    }
