...
//        to an integer by adding 1/2, taking the floor of the result after adding 1/2, and typecasting the result to type long.
...
public class speedConverterTwo {
    ...
    static void printConversion(double kilometersPerHour) {
        ...
        double milesPerHour;
        milesPerHour = (kilometersPerHour >= 0) ? (kilometersPerHour / 1.6) : -1;
        if (milesPerHour != -1) System.out.println(kilometersPerHour + " km/h = " + Math.round(milesPerHour) + " mi/h");
