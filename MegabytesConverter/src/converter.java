...
//
//        * printMegaBytesAndKiloBytes(-1024); → should print the following text: "Invalid Value" because parameter is
//        less than 0.
//
...
public class converter {
    static void printMegaBytesAndKiloBytes(int kiloBytes) {
        ...
        int megaBytes = ( kiloBytes >= 0 ) ? ( kiloBytes / 1024 ) : -1;
        int kiloBytesRemaining = kiloBytes - megaBytes * 1024;
        
        if ( megaBytes == -1 )              System.out.println("Invalid value!");
        else if (kiloBytesRemaining != 0)   System.out.println(kiloBytes + " KB = " + megaBytes + " MB and " + kiloBytesRemaining + " KB");
